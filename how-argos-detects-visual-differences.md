...
Argos compares **rendered screenshots** and [**ARIA snapshots**](playwright.md#aria-snapshots) produced by your E2E and Storybook tests.
...
* [Helpers](argos-helpers.md) to mask specific regions or elements

Learn more in [managing flaky tests](flaky-tests.md).
