...
* https://argos-ci.com/docs/quickstart/storybook
* https://argos-ci.com/docs/quickstart/storybook-test-runner
* https://argos-ci.com/docs/quickstart/storybook-legacy
...
For a deeper comparison, see: https://argos-ci.com/compare/chromatic

### Vitest vs Test Runner

Argos supports both Vitest and Test Runner for visual testing in Storybook.

Storybook recommends using Vitest for testing and Argos experience is also better if you use it. To learn more about the differences, see: https://storybook.js.org/docs/writing-tests/integrations/vitest-addon#comparison-to-the-test-runner
...
Argos supports Story modes to capture different states of your components. Read the Story modes guide: https://argos-ci.com/docs/storybook-story-modes
...
{% code title="ProductPage.stories.js" %}
```ts
...
{% code title="vitest-annotations.ts" %}
```ts
...
* https://argos-ci.com/docs/playwright#argosscreenshotpage-name-options
* https://js-sdk-reference.argos-ci.com/interfaces/UploadParameters.html
...
{% code title="test-runner-config.ts" %}
```ts
...
* `page`: The Playwright Page instance. https://playwright.dev/docs/api/class-page
...
* Quickstart with Argos + Storybook Legacy (\<v8): https://argos-ci.com/docs/quickstart/storybook-legacy
