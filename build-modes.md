...
* During these tests, your test framework (Playwright, Cypress, etc.) captures screenshots of the app. Argos offers [SDKs](./) for easy integration with popular frameworks.
...
Follow the [Get Started guide](./) to integrate Argos into your CI pipeline.
